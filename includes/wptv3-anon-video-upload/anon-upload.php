...
class WPTV_Anon_Upload {
	...
	function init() {
		// Use return URL from form if provided, otherwise default to submit-video page
		if ( ! empty( $_POST['wptv_return_url'] ) ) {
			$redir = esc_url_raw( $_POST['wptv_return_url'] );
		} else {
